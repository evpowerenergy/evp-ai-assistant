    ...
    <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          />
          <p className="mt-1 text-xs text-muted-foreground">Supported formats: PDF, DOC, DOCX, TXT, MD</p>
        </div>
        ...
        {success && (
          <div className="rounded-md bg-green-50 p-4 dark:bg-green-950/50">
            <p className="text-sm text-green-800 dark:text-green-300">Document uploaded successfully!</p>
          </div>
        )}
