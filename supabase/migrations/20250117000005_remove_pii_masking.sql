    -- Remove PII masking from ai_get_leads function
    -- Migration: 20250117000005_remove_pii_masking.sql
    -- Removes role-based masking to show all data regardless of user role

    -- Function: ai_get_leads (Show all data - no PII masking)
    ...
    BEGIN
        ...
        -- Get leads (show all data - no PII masking)
