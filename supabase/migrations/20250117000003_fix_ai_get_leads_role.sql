-- Fix ai_get_leads to accept role as parameter instead of querying auth.users
-- Migration: 20250117000003_fix_ai_get_leads_role.sql
-- Fixes: Role query from auth.users doesn't work via REST API, pass role as parameter

-- Function: ai_get_leads (Fixed version - accepts role parameter)
